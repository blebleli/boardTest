			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form id="frm" action="/studentUpdate" method="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<img src="/pic?std_id=${studentVo.std_id}" width=100>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
						<label for="coll_cnt" class="col-sm-2 control-label">학생 아이디</label>
							<input type="hidden" class="form-control" id="std_id" name="std_id"
									value ="${studentVo.std_id}"
									placeholder="학생 아이디">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="call_cnt" name="call_cnt"
									value ="${studentVo.call_cnt}"
									placeholder="호출횟수">
						</div>
					</div>
